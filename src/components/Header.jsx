        ...
        <div className="header-content backdrop-blur-sm h-full relative text-white">
          <div className="nav-content md:flex justify-between items-start">
            ...
            <ul
              className={
                display
                  ? 'hidden md:flex gap-10 text-white items-center pt-4 pr-14'
                  : 'flex absolute w-full box-border h-full top-0 text-white flex-col items-center justify-center text-2xl gap-10 bg-slate-900 animate__animated animate__fadeIn animate__faster'
              }
            >
              ...
              <li className="nav-item uppercase">
                <button
                  type="button"
                  className="bg-green-600 p-3 rounded animate__animated animate__pulse animate__infinite animate__fast"
                  id="downloadBtn"
                  value="download"
                  onClick={downloadPdf}
                >
          ...
          <section className="header-body px-4 md:pl-14 lg:pl-36 mt-16 md:mt-28 md:max-w-5xl ">
            <h2 className="text-5xl md:text-7xl lg:text-8xl font-bold">
              I'm <span className="text-orange-500">Steps</span>👋
            </h2>
